...
class CompanyController extends Controller
{
    ...
    public function company_panel(){
        ...
        $applications = DB::select("SELECT job_title,deadline,COUNT(cir_id) as numOf FROM applications INNER JOIN circulars on applications.cir_id=circulars.id where applications.c_id='$c_id' GROUP BY cir_id");
